...
(
	...
	ds_nome nvarchar(250) NULL DEFAULT NULL, 
	nr_cpf nvarchar(14) NULL DEFAULT NULL, 
	st_registro nvarchar(25) NULL DEFAULT NULL, 
...
(
	...
	ds_email nvarchar(100) NULL DEFAULT NULL, 
	co_senha nvarchar(200) NULL DEFAULT NULL, 
	st_registro nvarchar(25) NULL DEFAULT NULL, 
...
(
	...
	ds_perfil nvarchar(100) NULL DEFAULT NULL, 
...
(
	...
	ds_funcao nvarchar(200) NULL DEFAULT NULL, 
	ds_detalhe nvarchar(max) NULL, 
	ds_pagina_acesso nvarchar(200) NULL DEFAULT NULL, 
	st_registro nvarchar(25) NULL DEFAULT NULL, 
...
(
	...
	st_alterar nvarchar(25) NULL DEFAULT NULL, 
	st_cadastrar nvarchar(25) NULL DEFAULT NULL, 
	st_excluir nvarchar(25) NULL DEFAULT NULL, 
	st_visualizar nvarchar(25) NULL DEFAULT NULL, 
	st_registro nvarchar(25) NULL DEFAULT NULL, 
...
(
	...
	ds_tipo_acao nvarchar(200) NULL DEFAULT NULL, 
	dt_acao datetime2(0) NULL DEFAULT NULL, 
	ds_nivel_acao nvarchar(200) NULL DEFAULT NULL, 
...
(
	...
	ds_valor nvarchar(200) NULL DEFAULT NULL, 
...
INSERT INTO [tb_usuario] (id_pessoa, ds_email, co_senha, st_registro) 
VALUES (2, 'user@gov.br', NULL, 'ATIVO')
